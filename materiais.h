...
inline extern string Materiais[] = {
	...
	"redPlastic", "whitePlastic","yellowPlastic", "shinyPurple", "shinyOliveGreen", "shinySkyBlue" };
...
inline void loadMaterial(int material) {
	...
	GLfloat shinyPurpleAmb[] = { 0.2, 0.0, 0.4, 1. };
	GLfloat shinyPurpleDif[] = { 0.4, 0.0, 0.8, 1. };
	GLfloat shinyPurpleSpec[] = { 0.8, 0.6, 1.0, 1. };
	GLint shinyPurpleCoef = 0.9 * 128;

	GLfloat shinyOliveGreenAmb[] = { 0.2, 0.3, 0.1, 1. };
	GLfloat shinyOliveGreenDif[] = { 0.4, 0.5, 0.2, 1. };
	GLfloat shinyOliveGreenSpec[] = { 0.6, 0.8, 0.4, 1. };
	GLint shinyOliveGreenCoef = 0.9 * 128;

	GLfloat shinySkyBlueAmb[] = { 0.1, 0.2, 0.5, 1. };
	GLfloat shinySkyBlueDif[] = { 0.3, 0.5, 0.9, 1. };
	GLfloat shinySkyBlueSpec[] = { 0.6, 0.7, 1.0, 1. };
	GLint shinySkyBlueCoef = 0.9 * 128;
	...
	case 17: //……………………………………………………………………………………………yellowPlastic
		...
		break;
	case 18: // Shiny Purple
		glMaterialfv(GL_FRONT, GL_AMBIENT, shinyPurpleAmb);
		glMaterialfv(GL_FRONT, GL_DIFFUSE, shinyPurpleDif);
		glMaterialfv(GL_FRONT, GL_SPECULAR, shinyPurpleSpec);
		glMaterialf(GL_FRONT, GL_SHININESS, shinyPurpleCoef);
		break;
	case 19: // Shiny Olive Green
		glMaterialfv(GL_FRONT, GL_AMBIENT, shinyOliveGreenAmb);
		glMaterialfv(GL_FRONT, GL_DIFFUSE, shinyOliveGreenDif);
		glMaterialfv(GL_FRONT, GL_SPECULAR, shinyOliveGreenSpec);
		glMaterialf(GL_FRONT, GL_SHININESS, shinyOliveGreenCoef);
		break;
	case 20: // Shiny Sky Blue
		glMaterialfv(GL_FRONT, GL_AMBIENT, shinySkyBlueAmb);
		glMaterialfv(GL_FRONT, GL_DIFFUSE, shinySkyBlueDif);
		glMaterialfv(GL_FRONT, GL_SPECULAR, shinySkyBlueSpec);
		glMaterialf(GL_FRONT, GL_SHININESS, shinySkyBlueCoef);
		break;
	}
